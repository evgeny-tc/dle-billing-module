...
## [1.0.3] - 15.08.2026
### Добавлено
- Интеграция с Т‑Банком (интернет-эквайринг, чек 54‑ФЗ)
- Автотесты баланса, квитанций и подписи Т‑Банка
### Изменено
- Купон возвращается, если неоплаченная квитанция истекла
- ЛС и email отправляются после фиксации платежа
- События плагинов загружаются один раз за запрос
### Исправлено
- Перевод средств зачислялся отправителю вместо получателя
- Оплата квитанции и колбэки платежных систем
- Гонки при одновременном списании, кэш баланса в истории
- Журнал переводов и рефералов, лог интеграций, купоны при откате оплаты
- Дата в кабинете реферальной программы

## [1.0.2] - 04.06.2026
### Добавлено
- Новый API для подключения оплаты в сторонние модули
- Подробная карточка с информацией о платежах
### Изменено
- Рефакторинг кода
### Исправлено
