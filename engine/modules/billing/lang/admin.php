...
(
    ...
    'slider_transaction' => [
      ...
      'desc' => 'Описание',
      'no_desc' => 'Нет описания платежа',
      'plugin' => 'Плагин',
      'plugin_more_id' => 'ID внутри плагина',
      'user' => 'Пользователь',
      'login' => 'Логин',
      'group' => 'Группа',
      'ip' => 'IP',
      'agent_info' => 'Информация о агенте',
      'email' => 'Email',
      'reg' => 'Зарегистрирован',
      'last_visit' => 'Последний визит',
      'now_balance' => 'Текущий баланс',
      'user_ban' => 'Забанен',
    ...
    'slider_invoice' => [
      ...
      'sum_get' => 'Сумма к зачислению',
      'payment' => 'Способ оплаты',
      'about_pay' => 'Платеж совершен',
      'payer_info' => 'Плательщик',
      'payer_requisites' => 'Реквизиты',
      'sum_pay' => 'К оплате',
      'user_anonymous' => 'Неавторизованный пользователь',
      'handler' => 'Источник платежа',
    ],
	...
	'settings_page_desc' => "Укажите название <a href=\"?mod=static\">статической страницы</a> с личным кабинетом, а так же измените <a href='?mod=friendlyurl'>правила для ЧПУ</a>",
	...
	'settings_redirect' => "Авторедирект на сайт платежной системы:",
	...
	'settings_admin' => "Системный пользователь:",
	...
	'settings_format_desc' => "Формат отображения суммы платежа",

    'settings_commission' => "Зачислять коммиссию:",
    'settings_commission_desc' => "Если услуга предполагает комиссию сайта (при выводе средств, переводе и т.д.) - сумма комисси будет зачисляться на счет системного пользователя",
	...
	'act' => "Выполнить",
	'apply' => "Применить",
	'error_url' => "При сохранении правил обработки адресов возникли конфликты",
	'error_url_check' => "Проверить вручную",
	...
	'users_er_balance' => "Недостаточно средств на балансе пользователя «{user}»",
	'users_er_user_not_found' => "Пользователь «{user}» не найден",
	...
	'statistics_conversion_title' => "<i class='fa fa-filter'></i> Конверсия",
	'statistics_conversion_created' => "Создано квитанций",
	'statistics_conversion_paid' => "Оплачено",
	'statistics_conversion_unpaid' => "Не оплачено",
	'statistics_conversion_rate' => "Конверсия",
	'statistics_conversion_dropoff' => "отвал %s%%",
	'statistics_conversion_dropoff_col' => "Отвал",
	'statistics_conversion_expired' => "просрочено: %d",
	'statistics_conversion_selected' => "Выбрана платежная система",
	'statistics_conversion_no_paysys' => "Без выбора платежной системы — %d квит.",
	'statistics_conversion_no_payment' => "Платежная система не выбрана",
	'statistics_conversion_trend' => "Динамика конверсии",
	'statistics_conversion_funnel' => "Воронка оплаты",
	'statistics_conversion_paysys' => "Отвал по платежным системам",
	'statistics_conversion_chart' => "Конверсия и отвал по платежным системам",
	'statistics_conversion_lost' => "не получено",
	'statistics_conversion_more' => "Подробная аналитика конверсии →",
	...
	'upgrade_plugin' => "Обновление плагина до v.",
	'upgrade_wsql' => "Внимание, будут выполнены следующие SQL запросы:",
	'upgrade_rules' => "Внимание, будут установлены следующие правила обработки ЧПУ:",
	'upgrade_theme' => "<p>
	...
	'upgrade_plugin_ok' => "Плагин обновлен до версии ",
...
{include file="engine/modules/billing/widgets/push.php"}
	...
	'license' => "<p><a href=\"https://opensource.org/license/mit/\">The MIT License (MIT)</a></p>
					<p>Copyright (c) 2026 evgeny.tc@gmail.com (https://dle-billing.ru/)</p>
