...
(
	...
	'js_template' => "Вы можете использовать следующие теги в .tpl файлах Вашего шаблона
						<br /><br /><b>Панель пожертвований:</b><br />
							<p><pre><code>{tag1}</code></pre></p>
						<br /><b>Список принятых пользователем пожертвований:</b> <span style='float: right'>[ <a href='https://dle-billing.ru/doc/widgets/' target='_blank'><u>Подробнее на сайте</u></a> ]</span>
							<p><pre><code>{tag2}</code></pre></p>
						<br /><b>Всего пожертвовано пользователю:</b>
							<p><pre><code>{tag3}</code></pre></p>
						<br /><b>Внимание! Сгенерированные теги не сохраняются при обновлении страницы</b>",
	...
	'create_min' => "Минимальная сумма:",
	'create_min_desc' => "Минимальная сумма пожертвования",
	'create_max' => "Максимальная сумма:",
	...
	'create_code_desc' => "Пользователь может принимать пожертвования с неограниченного количества страниц. 
							<br>Для разделения платежей в общем списке - используйте уникальные <b>числовые</b> ключи.<br />Например, {news-id} - для разных новостей (только в shortstory.tpl и/или fullstory.tpl).",
	...
	'error_config' => "Плагин не настроен! Отсутствует файл data/billing/config.php",
	'error_config_plugin' => "Плагин не настроен! Отсутствует файл data/billing/plugin.donate.php",
);